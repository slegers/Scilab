funcprot(0)
test_cases = list()
test_cases($+1) = struct('input', struct('ns', [1]), 'output', struct('lone_wolf', 1))
test_cases($+1) = struct('input', struct('ns', [1,-1,2]), 'output', struct('lone_wolf', 2))
test_cases($+1) = struct('input', struct('ns', [1,2,-1]), 'output', struct('lone_wolf', 2))
test_cases($+1) = struct('input', struct('ns', [2,3,4,-3,-2]), 'output', struct('lone_wolf', 4))
test_cases($+1) = struct('input', struct('ns', [1,2,3,-1,-2]), 'output', struct('lone_wolf', 3))
